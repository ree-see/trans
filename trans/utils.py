...
# Supported faster-whisper device/compute-type targets.
# Defaults stay cpu/int8 — preserves the historical behavior for users
# who don't pass the flags. cuda/auto require the right wheel; the
# error surfaces at model-load time (and via -v traceback if needed).
WHISPER_DEVICES = ["cpu", "cuda", "auto"]
WHISPER_COMPUTE_TYPES = ["int8", "int8_float16", "float16", "float32"]
